...
export function Hero({
    ...
    description = ['Our advanced AI technology analyzes your symptoms, medical', 'history, and preferences to match you with the best-fit doctors', 'in seconds.'],
    buttons = {
        primary: {
                    ...
                    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-12">
                        ...
                        <div className="flex flex-col justify-center space-y-6">
                            ...
                            <div className="flex flex-col gap-4 sm:flex-row">
                                {buttons.primary && (
                                    <Button onClick={buttons.primary.onClick} className="h-[63.622px] gap-3 rounded-xl bg-blue-600 px-8 text-[15.3px] hover:bg-blue-700">
                            ...
                            <div className="w-full max-w-[559.929px] rounded-2xl bg-white p-8 shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)]">
                                ...
                                <form className="space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input id="symptoms" name="symptoms" placeholder={formCard.symptomPlaceholder} className="h-[49.787px] rounded-xl border-gray-300" />
                                    </div>
