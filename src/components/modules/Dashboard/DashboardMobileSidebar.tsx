...
const DashboardMobileSidebar = ({ userInfo, navItems, dashboardHome }: DashboardMobileSidebarProps) => {
    const pathname = usePathname();
    return (
        <div className="md:hidden flex h-full w-64 flex-col border-r bg-card">
            {/* Logo/Brand */}
