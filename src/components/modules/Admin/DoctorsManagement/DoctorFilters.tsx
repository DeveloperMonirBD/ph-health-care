    ...
    return (
        <div className="space-y-3">
            ...
            <div className="flex items-center gap-3">
                            ...
                            <CommandList>
                                ...
                                <CommandGroup>
                                    {specialties.map(specialty => {
                                        ...
                                        return (
                                            <CommandItem key={specialty.id} value={specialty.title} onSelect={() => toggleSpecialty(specialty.title)} className={isSelected ? 'bg-accent' : ''}>
                ...
                {/* Email Filter */}
                <Input type="email" placeholder="Email" value={emailInput} onChange={e => setEmailInput(e.target.value)} className="w-[200px] h-10" disabled={isPending} />

                {/* Contact Number Filter */}
                <Input type="text" placeholder="Contact" value={contactNumberInput} onChange={e => setContactNumberInput(e.target.value)} className="w-40 h-10" disabled={isPending} />
