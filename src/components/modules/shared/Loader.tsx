...
export default function HeartbeatLoader({ text = 'Next Level healthcare...', size = 'md', className = '', animated = true, showIcon = false }: HeartbeatLoaderProps) {
    const sizeClasses = {
        sm: 'w-20 h-20',
        md: 'w-32 h-32',
        lg: 'w-48 h-48',
                ...
                <div className="absolute inset-[15%] flex items-center justify-center">
                    {showIcon ? (
                        <motion.div
                            ...
                            <Activity className="text-blue-500" size={iconSizeClasses[size]} strokeWidth={2} />
                        </motion.div>
                    ) : (
